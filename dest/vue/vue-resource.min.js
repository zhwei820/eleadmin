...
!function (t, n) {
  ...
  function t(t) {
    ...
    var n = ["+", "#", ".", "/", ";", "?", "&"],
        e = [];return { vars: e, expand: function (o) {
    ...
    m(t.body) ? t.headers.delete("Content-Type") : (p(t.body) || ht(t.body)) && (t.emulateJSON ? (t.body = k.params(t.body), t.headers.set("Content-Type", "application/x-www-form-urlencoded")) : t.body = JSON.stringify(t.body)), n(function (t) {
      return Object.defineProperty(t, "data", { get: function () {
          return this.body;
        }, set: function (t) {
          this.body = t;
    ...
    et.installed || (e(t), t.url = k, t.http = Z, t.resource = tt, t.Promise = n, Object.defineProperties(t.prototype, { $url: { get: function () {
    ...
    return new t(function (e, o) {
      function r(t) {
        return function (o) {
          ...
          u = [];0 === n.length && e(u);for (var s = 0; s < n.length; s += 1) t.resolve(n[s]).then(r(s), o);
    });
  }, t.race = function (n) {
    return new t(function (e, o) {
